/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+java+json+json5+jsonp+ruby&plugins=toolbar+copy-to-clipboard+download-button */
var _self =
